...
class DTransformLayer : public Layer<Dtype> {
 public:
  explicit DTransformLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DTransform"; }
 ...
 protected:
  ...
  virtual void Backward_gpu(const vector<Blob<Dtype>*>& top,
      const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom);
 private:
  DTransformParameter dtransform_param_;
